/*
  # Add Stripe settings to store_settings

  1. Changes
    - Add Stripe settings to store_settings for tasker.dk store
    - Configure default Stripe settings with test mode enabled
*/
